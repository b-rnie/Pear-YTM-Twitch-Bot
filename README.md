...
* Head to [Twitch Developers](https://dev.twitch.tv),
  1. Create an application and register any name.
     * The application must be created under the 'bot account'.
...
* To use twitch token generator
  ...
  *  Copy 'Access Token' and 'Refresh Token' and place them somewhere safe.
...
INSERT INFO (HOW TO GET CHANNEL ID AND/OR BOT ID)
